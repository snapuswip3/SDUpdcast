...
Thanks petervas for bsdifflib, see the LICENSE text in the bspatch folder.
This project also needs fatfs, zlib, libpng and libbz2 to build, you can get them as KOS Ports, but their own licenses may apply.
